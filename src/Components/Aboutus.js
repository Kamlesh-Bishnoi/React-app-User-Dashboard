                ...
                <div className="card">
                  ...
                  <div className="card-body commonCard">
                    ...
                    <p className="card-text">
                      At InfoStride, we believe in lifelong learning. As a
                      consistently growing company providing talent, digital and
                      technology and services, we offer all our employees
